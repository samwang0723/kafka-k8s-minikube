...
{{/*
Expand the name of the zookeeper.
*/}}
...
{{- define "kafka.zookeeper.matchLabels" -}}
app.kubernetes.io/name: {{ include "kafka.zookeeper.fullname" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "kafka.zookeeper.labels" -}}
{{ include "kafka.common.metaLabels" .  }}
{{ include "kafka.zookeeper.matchLabels" . }}
{{- end -}}
